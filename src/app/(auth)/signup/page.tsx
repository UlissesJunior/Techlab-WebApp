...
import { amountStringToNumber, formatAmount, handleAmountInput } from '@/lib/transactionDialogUtils';
      ...
      {step === 3 && (
        <form className="space-y-6 sm:space-y-8" onSubmit={handleAccountCreation}>
          ...
          <DialogInput
            ...
            onChange={(e) => setAccountBalance(formatAmount(handleAmountInput(e.target.value)))}
          />
          <DialogButton
            type="submit"
            className="bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition cursor-pointer"
